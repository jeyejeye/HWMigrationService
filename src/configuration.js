class Configuration {
    ...
    init(names, ages, isHasPassport, genders, payments, healthies, quantityPersons) {
	    this.clear();
    ...
    setDefaultQuantityPersons() {
	    this.valQuantityPersons = parametersVisa.qtyPersons;
